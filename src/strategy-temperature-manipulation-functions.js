...
function run_buy_sell_algorithm(price_data,time_heat_1c,time_cool_1c,max_temp_adjustment,min_saving_NOK_kWh) {
    ...
    buy_sell_cleaned = remove_low_buysell_pairs(buy_sell,buy_prices,sell_prices,min_saving_NOK_kWh, start_date)
    buy_sell_value_dictlist_cleaned = calculate_value_dictlist(buy_sell_cleaned,buy_prices,sell_prices, start_date)
