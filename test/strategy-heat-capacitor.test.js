...
const { calculateSchedule, calculateOpportunities, findBestBuySellPattern, calculateValueDictlist, removeLowBuySellPairs } = require("../src/strategy-heat-capacitor-functions");
